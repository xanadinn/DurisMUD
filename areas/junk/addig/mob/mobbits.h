...
typedef struct _affect2BitFlags
{
  ...
  unsigned protGas     : 1;
  unsigned protAcid    : 1;
  unsigned autoFiring  : 1;
  unsigned hunter      : 1;
  unsigned msslAware   : 1;
  unsigned msslSnare   : 1;
  unsigned msslShield  : 1;
  unsigned stunned     : 1;
  ...
  unsigned casting     : 1;
  unsigned scribing    : 1;
  unsigned vampiric    : 1;  // vampiric touch
} affect2BitFlags;
...
{
  unsigned tensorsDisc : 1;
  unsigned tracking    : 1;
  unsigned singing     : 1;
  unsigned ectoForm    : 1;
  unsigned absorbing   : 1;
  unsigned drainee     : 1;
  unsigned spiritWard  : 1;
  unsigned grSpirWard  : 1;
  unsigned nonDetect   : 1;
  unsigned silver      : 1;
  unsigned plusone     : 1;
  unsigned plustwo     : 1;
  ...
  unsigned reduced     : 1;
  unsigned cover       : 1;
  unsigned hasFourArms : 1;
  unsigned inertBarr   : 1;
  unsigned intelFort   : 1;
  unsigned coldshield  : 1;
  unsigned cannibalize : 1;
  unsigned swimming    : 1;
  unsigned towerIronW  : 1;
  unsigned underwater  : 1;
  unsigned blur        : 1;
  unsigned neckbiting  : 1;
  unsigned elemForm    : 1;
  unsigned passWOtrace : 1;
  unsigned paladinAura : 1;
  unsigned famine      : 1;
} affect3BitFlags;
...
{
  unsigned looter      : 1;
  unsigned carryDiseas : 1;
  unsigned sacking     : 1;
  unsigned senseFoll   : 1;
  unsigned stornogsSph : 1;
  unsigned grStorSph   : 1;
  unsigned vampireForm : 1;
  unsigned noUnmorph   : 1;
  unsigned holySacri   : 1;
  unsigned battleEcst  : 1;
  unsigned dazzler     : 1;
  unsigned dazzlee     : 1;
  ...
  unsigned grapple     : 1;
  unsigned grappled    : 1;
  unsigned mageFlame   : 1;
  unsigned noImmolate  : 1;
  unsigned multiNPC    : 1;
